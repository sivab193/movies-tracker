...
import { Film, Mail, Lock, Loader2, ArrowLeft } from "lucide-react"
      ...
      <div className="flex-1 flex items-center justify-center p-4">
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-2xl">Welcome to TitleCard Timer</CardTitle>
            <CardDescription>
              Sign in to track your movie watches and spending
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Button
