...
Follow the prompts:
1. Visit: https://media-verse.in/device
...
```json
{
  ...
  "version": "1.0.0",
  "description": "MCP server for Movies Tracker - https://media-verse.in",
  "repository": {
    "type": "git",
...
```bash
curl https://media-verse.in/api/health
```
...
2. User visits https://media-verse.in/device
   ├─> Enters userCode
