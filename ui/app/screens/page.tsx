...
const formats: GuideCard[] = [
  ...
  { icon: Projector, title: "P[XL] (PVR)", tagline: "PVR's premium extra-large format", whatChanges: "P[XL] is PVR's PLF label. It is typically promoted around a wall-to-wall large screen, laser projection and immersive sound; individual auditoriums can differ in seating, 3D and projection setup.", lookFor: ["Large curved / wall-to-wall screen", "Laser projection", "Location-specific specs"] },
  { icon: Projector, title: "BigPix (INOX)", tagline: "INOX's 4K large-screen format", whatChanges: "BigPix is INOX's large-format label. PVR INOX describes it around a huge screen, 4K laser projection, Dolby Atmos and premium seating, but the exact combination is auditorium-specific.", lookFor: ["Large screen", "4K laser", "Dolby Atmos at select sites"] },
  { icon: Projector, title: "Macro XE (Cinépolis)", tagline: "Cinépolis' large-screen format", whatChanges: "Macro XE is Cinépolis' premium large-format screen. It is built around increased screen scale and a premium presentation; the projection and sound specification should always be checked at the chosen cinema.", lookFor: ["PLF", "Large screen", "Venue-specific audio and projection"] },
  { icon: PanelsTopLeft, title: "ICE Theaters", tagline: "Main screen plus peripheral LED panels", whatChanges: "ICE Immersive extends selected content onto non-reflective LED panels along the side walls, adding peripheral visual atmosphere while the main screen remains the focus.", lookFor: ["Side LED panels", "ICE Immersive content", "Not the same as ScreenX"] },
  { icon: Projector, title: "Samsung Onyx", tagline: "A cinema LED display, not a projector", whatChanges: "Onyx creates the image directly from an LED display rather than projecting onto a screen. That can enable very high brightness, HDR, true blacks and uniform picture quality; it is still rare compared with projection.", lookFor: ["Direct-view LED", "HDR", "No projector beam"] },
  ...
  { icon: Sparkles, title: "Dolby Vision", tagline: "The picture technology", whatChanges: "Dolby Vision is about image presentation: high dynamic range, brighter highlights, deeper blacks and more visible shadow detail when the full system and movie master support it. It is not a synonym for Atmos.", lookFor: ["HDR picture", "Deep blacks", "Image, not sound"] },
  { icon: Speaker, title: "Dolby Atmos", tagline: "The sound technology", whatChanges: "Atmos uses audio objects and overhead speakers so sounds can be placed and moved more precisely around the auditorium. A theatre may offer Atmos without Dolby Vision or Dolby Cinema.", lookFor: ["Object-based audio", "Ceiling speakers", "Audio, not picture"] },
  { icon: Sparkles, title: "Dolby Cinema", tagline: "The full Dolby premium package", whatChanges: "Dolby Cinema is a complete branded auditorium that combines Dolby Vision and Dolby Atmos with Dolby's cinema design. It is different from a theatre merely advertising Atmos.", lookFor: ["Dolby Vision", "Dolby Atmos", "Dedicated auditorium"] },
  ...
  { icon: Sparkles, title: "RealD 3D", tagline: "The 3D presentation system", whatChanges: "RealD 3D uses polarized glasses to create depth. The image quality depends heavily on the projector brightness, screen size and how well the specific auditorium is maintained.", lookFor: ["Polarized glasses", "3D image", "Brightness matters"] },
