        ...
        <div className="mx-auto max-w-7xl w-full px-4 py-8 space-y-6">
            <div className="flex items-center gap-4">
                <Link href="/admin/users">
                    <Button variant="ghost" size="icon" aria-label="Go back" title="Go back"><ArrowLeft className="h-4 w-4" /></Button>
                </Link>
                                    ...
                                    <TableRow key={entry._id || i}>
                                        ...
                                        <TableCell>
                                            <div className="flex items-center justify-end gap-2">
                                                ...
                                                <Button variant="ghost" size="icon" aria-label="Delete entry" title="Delete entry" className="h-8 w-8 text-destructive hover:text-destructive" onClick={() => entry._id && setDeletingId(entry._id)}>
