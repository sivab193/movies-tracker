...
export function AdminOttCatalog({ standalone = false }: { standalone?: boolean } = {}) {
  ...
  return <CollapsibleSection defaultOpen={standalone} title={<><Tv className="h-5 w-5 text-primary" />OTT catalog</>} description="Browse every title linked to each streaming service">
