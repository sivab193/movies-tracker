...
import { Home, Film, Trophy, Clock, CreditCard } from "lucide-react"
...
const navItems = [
  ...
  { href: "/watch-history", label: "History", icon: Clock, authOnly: true },
  { href: "/cards", label: "Cards", icon: CreditCard, authOnly: true },
]
